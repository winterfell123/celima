...
def createData(ruta1,ruta2,file):
    ...
    template.save("C:\\Users\\rmedinac\\Desktop\\celima\\Saint T-Gobain\\ZSDP580\\"+file+"ZSDP580"+".xlsx")
    print("Range copied and pasted!")

				
if __name__ == "__main__":
    arvhivos = [] 
    ruta = "C:\\Users\\rmedinac\\Desktop\\celima\\Saint T-Gobain\\"
    arvhivos=ls1(ruta)
    print(arvhivos)
    for v in arvhivos:
        print("C:\\Users\\rmedinac\\Desktop\\celima\\Saint T-Gobain\\"+v)
        print(v.find(".xlsx"))
        if v.find(".xlsx") == -1:
            pass
        else:
            ...
            file = v[0:len(v)-5]
            print(file)
            createData("C:\\Users\\rmedinac\\Desktop\\celima\\Saint T-Gobain\\"+v,"ZSDP580 - copia.xlsx",file)
            remove("C:\\Users\\rmedinac\\Desktop\\celima\\Saint T-Gobain\\"+v)