...
def createData(ruta1,ruta2,file):
    ...
    pastingRange = pasteRange1(17,2,17,2+max_row1,temp_sheet,date_time) #Change the 4 number values

    template.save("C:\\Users\\rmedinac\\Desktop\\celima\\Corporacion Celima\\ZSDP580\\"+file+"ZSDP580"+".xlsx")
    print("Range copied and pasted!")

				
if __name__ == "__main__":
    arvhivos = [] 
    ruta = "C:\\Users\\rmedinac\\Desktop\\celima\\Corporacion Celima\\"
    arvhivos=ls1(ruta)
    print(arvhivos)
    for v in arvhivos:
        print("C:\\Users\\rmedinac\\Desktop\\celima\\Corporacion Celima\\"+v)
        print(v.find(".xlsx"))
        if v.find(".xlsx") == -1:
            pass
        else:
            ...
            file = v[0:len(v)-5]
            print(file)
            createData("C:\\Users\\rmedinac\\Desktop\\celima\\Corporacion Celima\\"+v,"ZSDP580 - copia.xlsx",file)
            remove("C:\\Users\\rmedinac\\Desktop\\celima\\Corporacion Celima\\"+v)